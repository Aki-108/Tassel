...
(function() {
    ...
    function createPage_skdasoyk() {
        ...
        blacklistView.style = "display:grid;grid-template-columns:25% 25% auto auto auto auto 25%;padding:10px;background:var(--postBgColor);grid-gap:5px;";
        ...
        for (let a = 0; a < 7; a++) {
            ...
            header.innerHTML = `
                <div>
                    ...
                    <div style="z-index:2;position:relative;">${titles[a]}</div>
                </div>
            `;
            ...
            header.addEventListener("mouseenter", showInfoBubble_skdasoyk);
            header.addEventListener("mouseleave", hideInfoBubble_skdasoyk);
        ...
        infoBubble.id = "tasselBlacklistInfo";
        infoBubble.style = "display:none;height:max-content;width:26em;background:var(--postBgColor);position:fixed;top:170px;left:calc(50% - 13em);box-shadow:0 1px 5px 0 grey;line-height:1em;padding:10px;z-index:3;";
        body.appendChild(infoBubble);
    ...
    function showInfoBubble_skdasoyk() {
        let bubble = document.getElementById("tasselBlacklistInfo");
        bubble.innerHTML = this.getAttribute("info");
        bubble.style.display = "block";
    }

    function hideInfoBubble_skdasoyk() {
        let bubble = document.getElementById("tasselBlacklistInfo");
